...
import com.example.springboot_webservice.domain.posts.PostsRepository;
...
public class PostsService {
    ...
    public Long update(Long id, PostsUpdateRequestDto requestDto) {
        Posts posts = postsRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("해당 게시글이 없습니다.(update) id="+id));
    ...
    public void delete(Long id) {
        Posts posts = postsRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("해당 게시글이 없습니다.(delete) id="+id));
